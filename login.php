    ...
    <div class="container-fluid" style="margin-top:60px;margin-bottom:60px;color:#34495E;">
      <div class="row">
         ...
         <div class="col-md-4" style="margin-top: 5%;right: 8%">
          <div class="card" style="font-family: 'IBM Plex Sans', sans-serif; padding-left: 8%;">
            <div class="card-body">
              <center>
                <br>
              ...
              <form method="post" action="func3.php">
                <div class="row" style="margin-top: 10%">
                  ...
                  <div class="col-md-8"><input type="text" name="username1" class="form-control" placeholder="Username" required/></div><br><br>
                ...
                <div class="row">
                 <div class="col-md-4"  style="padding-left: 160px;margin-top: 10%">
                    <center><button type="submit" id="inputbtn" name="adsub" value="Login" class="btn btn-success">Login</button></center></div>         
                </div>
              </form>
            </center>
            </div>
